...
import QuickSwapIntegration from './components/QuickSwapIntegration.jsx';
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          <h2 style={{ 
            ...
            🚀 GIVE Token - Now Trading!
          </h2>
          <p style={{ fontSize: '1.2rem', opacity: 0.9, maxWidth: '600px', margin: '0 auto' }}>
            Join the revolution in charitable giving. Trade GIVE tokens now on QuickSwap DEX!
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', alignItems: 'start' }} className="grid-two-columns">
          ...
          {/* Right: QuickSwap Trading Interface */}
          <QuickSwapIntegration tokenAddress="0xf45092BAddf17f6E4fBe18962814C90f8F983e34" />
        </div>
        ...
        <div style={{
          ...
          <h4 style={{ fontSize: '1.3rem', fontWeight: 'bold', marginBottom: '15px', color: '#fbbf24' }}>
            🔒 QuickSwap DEX Trading
          </h4>
          <p style={{ fontSize: '1rem', opacity: 0.9, marginBottom: '20px' }}>
            GIVE tokens are now live on QuickSwap DEX with real liquidity. 
            Trade securely with decentralized, transparent, and instant transactions.
          </p>
